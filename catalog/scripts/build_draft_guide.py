...
GOING_SECOND = {
    ...
    "steps": [
        ("Their faction ban (first ban)",
         ...
         "or Dungeon."),
        ("Your faction ban",
         "Now you have full information AND first pick. Ban the faction whose matchup counter "
         "you'd LESS want to play. Standard lines: "
         "(a) They banned Necro → **ban Dungeon, pick Grove** (Halon/Sullie + Avatar Vomit > "
         "Onyx Dancer grind vs Temple's likely counter-pick). "
         "(b) They banned Grove → **ban Dungeon, pick Necropolis** (Necro's deep pool > "
         "Dungeon's hero-ban-vulnerable top 4). "
         "(c) They banned Dungeon → **ban Grove, pick Necropolis** (or Grove if Sullie/Halon "
         "still alive). "
         "If they didn't ban Necro, ban Grove or Dungeon and take Necropolis."),
        ("Your faction pick (first pick)",
         "Pick the strongest *matchup-favored* faction. Default order: Necropolis > Grove > "
         "Dungeon > Temple. **Important**: don't reflexively pick the 'strongest' faction — "
         "consult the counter-pick matrix. Dungeon is a great pure-power pick but is a *worse* "
         "counter to Temple than Grove."),
