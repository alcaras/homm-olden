const UnitsView = ({ go }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", null, "Units \u2014 Creature Stats"), /* @__PURE__ */ React.createElement("p", { className: "lede" }, "Every recruitable creature in the game \u2014 six factions plus neutral, in three variants per stack: ", /* @__PURE__ */ React.createElement("em", null, "base"), " (recruited from the dwelling),", " ", /* @__PURE__ */ React.createElement("em", null, "upgrade"), " (the standard improvement), and ", /* @__PURE__ */ React.createElement("em", null, "alt upgrade"), " ", "(the alternate option)."), /* @__PURE__ */ React.createElement("h2", null, "Browse by faction"), /* @__PURE__ */ React.createElement("p", { className: "note" }, "Per-faction page: all 7 tiers stacked, each tier showing base / upgrade / alt as 3 cards with stats, passives, and abilities side by side."), /* @__PURE__ */ React.createElement("div", { className: "faction-strip" }, FACTIONS.map((f) => /* @__PURE__ */ React.createElement(
    "a",
    {
      key: f.id,
