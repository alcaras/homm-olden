...
const titleFor = (route) => {
  ...
  switch (route.view) {
    ...
    case "spells":
      return t("Spells");
    case "map-objects":
      return t("Map Objects");
    case "map-templates":
      return t("Map Templates");
    case "resources":
      return t("Resources");
    case "artifacts":
      return t("Artifacts");
...
const App = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("header", { className: "masthead" }, /* @__PURE__ */ React.createElement("a", { className: "brand", href: url(""), onClick: (e) => {
    ...
    e.preventDefault();
    go("spells");
  } }, "Spells"), /* @__PURE__ */ React.createElement("a", { className: tabActive("map-objects"), href: url("map-objects"), onClick: (e) => {
    e.preventDefault();
    go("map-objects");
  } }, "Map objects"), /* @__PURE__ */ React.createElement("a", { className: tabActive("map-templates"), href: url("map-templates"), onClick: (e) => {
    e.preventDefault();
    go("map-templates");
  } }, "Templates"), /* @__PURE__ */ React.createElement("a", { className: tabActive("resources"), href: url("resources"), onClick: (e) => {
    e.preventDefault();
    go("resources");
  } }, "Resources"), /* @__PURE__ */ React.createElement("a", { className: tabActive("artifacts"), href: url("artifacts"), onClick: (e) => {
    e.preventDefault();
    go("artifacts");
  } }, "Artifacts"), /* @__PURE__ */ React.createElement("a", { className: tabActive("heroes"), href: url("heroes"), onClick: (e) => {
    e.preventDefault();
    go("heroes");
  } }, "Heroes"), /* @__PURE__ */ React.createElement("a", { className: tabActive("units"), href: url("units"), onClick: (e) => {
    e.preventDefault();
    go("units");
  } }, "Units"), /* @__PURE__ */ React.createElement("a", { className: tabActive("combat"), href: url("combat"), onClick: (e) => {
    e.preventDefault();
    go("combat");
  } }, "Combat sim"), /* @__PURE__ */ React.createElement("a", { className: tabActive("hotkeys"), href: url("hotkeys"), onClick: (e) => {
    e.preventDefault();
    go("hotkeys");
  } }, "Hotkeys"), /* @__PURE__ */ React.createElement("a", { className: tabActive("builder"), href: url("builder"), onClick: (e) => {
    e.preventDefault();
    go("builder");
  } }, "Hero Level-Up Simulator"), /* @__PURE__ */ React.createElement("a", { className: tabActive("astrology"), href: url("astrology"), onClick: (e) => {
    e.preventDefault();
    go("astrology");
  } }, "Astrology & Insight"), /* @__PURE__ */ React.createElement("a", { className: tabActive("tier"), href: url("tier"), onClick: (e) => {
    e.preventDefault();
    go("tier");
