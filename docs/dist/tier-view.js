const TierView = () => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h1", null, "Tournament tier list"), /* @__PURE__ */ React.createElement("div", { className: "tier-scale" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("b", null, "S"), " perma-pick / perma-ban"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("b", null, "A"), " strong contested"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("b", null, "B"), " situational / playable"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("b", null, "C"), " avoid in single-hero Exodus"), /* @__PURE__ */ React.createElement("span", { className: "tier-derived-key" }, /* @__PURE__ */ React.createElement("em", null, "(data)"), " uncited \u2014 derived from extracted data only")), /* @__PURE__ */ React.createElement("h2", null, "Opening-pick archetypes"), /* @__PURE__ */ React.createElement("div", { className: "archetypes" }, T.OPENING_PICKS.map((p) => /* @__PURE__ */ React.createElement("div", { className: "archetype", key: p.title }, /* @__PURE__ */ React.createElement("div", { className: "archetype-title" }, p.title), /* @__PURE__ */ React.createElement("div", { className: "archetype-body" }, p.body)))), /* @__PURE__ */ React.createElement("h2", null, "Per-faction tiers"), /* @__PURE__ */ React.createElement("div", { className: "controls" }, /* @__PURE__ */ React.createElement("div", { className: "filter-group" }, /* @__PURE__ */ React.createElement("label", null, "Factions"), /* @__PURE__ */ React.createElement("div", { className: "seg multi" }, /* @__PURE__ */ React.createElement(
    "button",
    {
