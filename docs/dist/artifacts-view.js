const ArtifactsView = () => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h1", null, "Artifacts"), /* @__PURE__ */ React.createElement("p", { className: "lede" }, "117 artifacts across 9 equipment slots, plus 24 item sets that grant bonus effects when you equip multiple pieces. Stats, rarity, and set membership pulled from ", /* @__PURE__ */ React.createElement("code", null, "DB/items/items/"), " and", " ", /* @__PURE__ */ React.createElement("code", null, "DB/items/item_sets/"), "; icons from", " ", /* @__PURE__ */ React.createElement("code", null, "resources.assets"), "."), /* @__PURE__ */ React.createElement("div", { className: "controls" }, /* @__PURE__ */ React.createElement("div", { className: "filter-group" }, /* @__PURE__ */ React.createElement("label", null, "Slot"), /* @__PURE__ */ React.createElement("div", { className: "seg" }, /* @__PURE__ */ React.createElement("button", { className: slot === "all" ? "active" : "", onClick: () => setSlot("all") }, "All"), A.SLOT_ORDER.map((s) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: s,
